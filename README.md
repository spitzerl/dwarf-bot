...
Duplicate `.env.example` file in `.env` then enter your datas | Field | Content | |--- |:- | |TOKEN |Your bot token (available on developer portal)| |CLEINT_ID |Application ID (available on developer portal)| |GUILD_ID |ID of your development server |
